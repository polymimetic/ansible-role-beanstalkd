...
# https://github.com/polymimetic/ansible-role-beanstalkd
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/ansible-role-beanstalkd/master/install.sh | bash
#
###########################################################################
...
readonly GIT_REPO="https://github.com/polymimetic/ansible-role-beanstalkd.git"
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/ansible-role-beanstalkd/master"
